        ...
        return Agent(
            ...
            instructions=[
                ...
                r"""
                    ...
                    -Tables: Include sample data rows with clear, readable column headers, and use \resizebox{\textwidth}{!}{\begin{tabular}...} or \begin{tabularx}{\textwidth}{lXlX} for wide tables to ensure compact formatting.
